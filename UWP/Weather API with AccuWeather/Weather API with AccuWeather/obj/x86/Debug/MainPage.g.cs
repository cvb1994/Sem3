#pragma checksum "E:\Code\Sem3\UWP\Weather API with AccuWeather\Weather API with AccuWeather\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "59B03BF98A44467A2C7801047DDD41C9"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Weather_API_with_AccuWeather
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Weather_API_with_AccuWeather.Models.DailyForecast dataRoot;
            ...
            {
                if (lineNumber == 125 && columnNumber == 36)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Weather_API_with_AccuWeather.Models.DailyForecast) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Weather_API_with_AccuWeather.Models.DailyForecast)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Weather_API_with_AccuWeather.Models.DailyForecast obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_day(global::Weather_API_with_AccuWeather.Models.Day obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::Weather_API_with_AccuWeather.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum(global::Weather_API_with_AccuWeather.Models.Maximum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Minimum(global::Weather_API_with_AccuWeather.Models.Minimum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj11_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Weather_API_with_AccuWeather.Models.WeatherJSON dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 93 && columnNumber == 29)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Weather_API_with_AccuWeather.Models.WeatherJSON) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Weather_API_with_AccuWeather.Models.WeatherJSON)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Weather_API_with_AccuWeather.Models.WeatherJSON obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_temperature(global::Weather_API_with_AccuWeather.Models.Temperature obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Weather_API_with_AccuWeather.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 116 && columnNumber == 13)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Weather_API_with_AccuWeather.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Weather_API_with_AccuWeather.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_WeatherEachDays(global::System.Collections.ObjectModel.ObservableCollection<global::Weather_API_with_AccuWeather.Models.DailyForecast> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_WeatherEachHours(global::System.Collections.ObjectModel.ObservableCollection<global::Weather_API_with_AccuWeather.Models.WeatherJSON> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
